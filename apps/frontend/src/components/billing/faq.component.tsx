  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              `Am I going to be charged by ${appName}?`
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              `To confirm credit card information ${appName} will hold $2 and release it immediately`
            ),
          },
        ]
      : []),
    ...
    },
    {
      ...
      description: t(
        ...
        `${appName} allows you to schedule your posts between different channels.
